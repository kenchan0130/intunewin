...
- chore(deps): update actions/checkout action to v5.0.1 by @renovate[bot] in https://github.com/kenchan0130/intunewin/pull/12
- chore(deps): update aquaproj/aqua-installer action to v4.0.4 by @renovate[bot] in https://github.com/kenchan0130/intunewin/pull/13
- chore(deps): update actions/setup-go action to v5.6.0 by @renovate[bot] in https://github.com/kenchan0130/intunewin/pull/14
- add aqua for renovate settings by @kenchan0130 in https://github.com/kenchan0130/intunewin/pull/15
- chore(deps): update reviewdog/action-actionlint action to v1.71.0 by @renovate[bot] in https://github.com/kenchan0130/intunewin/pull/17
- chore(deps): update songmu/tagpr action to v1.17.0 by @renovate[bot] in https://github.com/kenchan0130/intunewin/pull/18
- chore(deps): update actions/checkout action to v6 by @renovate[bot] in https://github.com/kenchan0130/intunewin/pull/19
- chore(deps): update actions/setup-go action to v6.2.0 by @renovate[bot] in https://github.com/kenchan0130/intunewin/pull/20
- chore(deps): update dependency suzuki-shunsuke/ghalint to v1.5.5 by @renovate[bot] in https://github.com/kenchan0130/intunewin/pull/22
- chore(deps): update dependency aquaproj/aqua to v2.56.6 by @renovate[bot] in https://github.com/kenchan0130/intunewin/pull/23
- chore(deps): update dependency aquaproj/aqua-registry to v4.474.0 by @renovate[bot] in https://github.com/kenchan0130/intunewin/pull/24
- chore(deps): update dependency aquaproj/aqua-renovate-config to v2.10.0 by @renovate[bot] in https://github.com/kenchan0130/intunewin/pull/25
- chore(deps): update module github.com/golangci/golangci-lint/v2 to v2.10.1 by @renovate[bot] in https://github.com/kenchan0130/intunewin/pull/16

## [v0.0.4](https://github.com/kenchan0130/intunewin/compare/v0.0.3...v0.0.4) - 2026-02-22
- fix: use Store for outer .intunewin ZIP entries so Intune accepts uploads by @kenchan0130 in https://github.com/kenchan0130/intunewin/pull/7

## [v0.0.3](https://github.com/kenchan0130/intunewin/compare/v0.0.2...v0.0.3) - 2025-12-09
